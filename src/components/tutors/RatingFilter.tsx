          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? "bg-emerald-500/5 border-emerald-500/30 text-emerald-600 dark:text-emerald-400 shadow-xs"
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isSelected
                    ? "border-emerald-600 bg-emerald-500 dark:border-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.2)]"
