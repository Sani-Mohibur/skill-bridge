...
export default function RegisterForm() {
  ...
  return (
    <div className="relative group w-full max-w-md">
      ...
      <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 opacity-20 blur-xl group-hover:opacity-30 transition duration-1000" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-11 rounded-xl bg-background/50 focus-visible:ring-emerald-500/20 focus-visible:border-emerald-500 transition-all duration-300"
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full h-11 rounded-xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold tracking-wide shadow-lg shadow-emerald-600/10 transition-all duration-300 mt-4 cursor-pointer"
          >
